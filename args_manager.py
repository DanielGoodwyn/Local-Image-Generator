...
# For example, https://github.com/lllyasviel/Local Image Generator/issues/849
...
# (Disable by default because of issues like https://github.com/lllyasviel/Local Image Generator/issues/724)
