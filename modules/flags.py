...
# local_image_generator: a1111 (Civitai)
KSAMPLER = {
    "euler": "Euler",
...
class MetadataScheme(Enum):
    LOCAL_IMAGE_GENERATOR = 'local_image_generator'
    A1111 = 'a1111'


metadata_scheme = [
    (f'{MetadataScheme.LOCAL_IMAGE_GENERATOR.value} (json)', MetadataScheme.LOCAL_IMAGE_GENERATOR.value),
