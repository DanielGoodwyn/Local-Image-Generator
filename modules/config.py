...
def try_load_deprecated_user_path_config():
    ...
    try:
        ...
        replace_config('local_image_generator_expansion_path', 'path_local_image_generator_expansion')
...
path_local_image_generator_expansion = get_dir_or_set_default('path_local_image_generator_expansion', '../models/prompt_expansion/local_image_generator_expansion')
...
default_temp_path = os.path.join(tempfile.gettempdir(), 'local_image_generator')
...
default_metadata_scheme = get_config_item_or_set_default(
    ...
    default_value=MetadataScheme.LOCAL_IMAGE_GENERATOR.value,
...
def get_model_filenames(folder_paths, extensions=None, name_filter=None):
    if extensions is None:
        extensions = ['.pth', '.ckpt', '.bin', '.safetensors', '.local_image_generator.patch']
    files = []
...
def downloading_inpaint_models(v):
    ...
    load_file_from_url(
        url='https://huggingface.co/lllyasviel/local_image_generator_inpaint/resolve/main/local_image_generator_inpaint_head.pth',
        model_dir=path_inpaint,
        file_name='local_image_generator_inpaint_head.pth'
    )
    head_file = os.path.join(path_inpaint, 'local_image_generator_inpaint_head.pth')
    patch_file = None

    if v == 'v1':
        load_file_from_url(
            url='https://huggingface.co/lllyasviel/local_image_generator_inpaint/resolve/main/inpaint.local_image_generator.patch',
            model_dir=path_inpaint,
            file_name='inpaint.local_image_generator.patch'
        )
        patch_file = os.path.join(path_inpaint, 'inpaint.local_image_generator.patch')

    if v == 'v2.5':
        load_file_from_url(
            url='https://huggingface.co/lllyasviel/local_image_generator_inpaint/resolve/main/inpaint_v25.local_image_generator.patch',
            model_dir=path_inpaint,
            file_name='inpaint_v25.local_image_generator.patch'
        )
        patch_file = os.path.join(path_inpaint, 'inpaint_v25.local_image_generator.patch')

    if v == 'v2.6':
        load_file_from_url(
            url='https://huggingface.co/lllyasviel/local_image_generator_inpaint/resolve/main/inpaint_v26.local_image_generator.patch',
            model_dir=path_inpaint,
            file_name='inpaint_v26.local_image_generator.patch'
        )
        patch_file = os.path.join(path_inpaint, 'inpaint_v26.local_image_generator.patch')
...
def downloading_controlnet_cpds():
    load_file_from_url(
        url='https://huggingface.co/lllyasviel/misc/resolve/main/local_image_generator_xl_cpds_128.safetensors',
        model_dir=path_controlnet,
        file_name='local_image_generator_xl_cpds_128.safetensors'
    )
    return os.path.join(path_controlnet, 'local_image_generator_xl_cpds_128.safetensors')
...
def downloading_ip_adapters(v):
    ...
    load_file_from_url(
        url='https://huggingface.co/lllyasviel/misc/resolve/main/local_image_generator_ip_negative.safetensors',
        model_dir=path_controlnet,
        file_name='local_image_generator_ip_negative.safetensors'
    )
    results += [os.path.join(path_controlnet, 'local_image_generator_ip_negative.safetensors')]
...
def downloading_upscale_model():
    load_file_from_url(
        url='https://huggingface.co/lllyasviel/misc/resolve/main/local_image_generator_upscaler_s409985e5.bin',
        model_dir=path_upscale_models,
        file_name='local_image_generator_upscaler_s409985e5.bin'
    )
    return os.path.join(path_upscale_models, 'local_image_generator_upscaler_s409985e5.bin')
