...
branded_style_aliases = {
    'Fooocus Enhance': 'Image Enhance',
    'Fooocus Semi Realistic': 'Semi Realistic',
    'Fooocus Sharp': 'Image Sharp',
    'Fooocus Masterpiece': 'High Detail',
    'Fooocus Photograph': 'Photograph',
    'Fooocus Negative': 'Quality Negative',
    'Fooocus Cinematic': 'Cinematic',
    'Fooocus Pony': 'Pony',
}
...
fooocus_expansion = 'Prompt Expansion'
