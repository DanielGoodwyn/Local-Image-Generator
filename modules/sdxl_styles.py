...
for x in ['sdxl_styles_local_image_generator.json',
...
branded_style_aliases = {
    'Local Image Generator Enhance': 'Image Enhance',
    'Local Image Generator Semi Realistic': 'Semi Realistic',
    'Local Image Generator Sharp': 'Image Sharp',
    'Local Image Generator Masterpiece': 'High Detail',
    'Local Image Generator Photograph': 'Photograph',
    'Local Image Generator Negative': 'Quality Negative',
    'Local Image Generator Cinematic': 'Cinematic',
    'Local Image Generator Pony': 'Pony',
}

for old_name, new_name in branded_style_aliases.items():
    if old_name in styles:
        styles[new_name] = styles.pop(old_name)

style_keys = list(styles.keys())
local_image_generator_expansion = 'Prompt Expansion'
random_style_name = 'Random Style'
legal_style_names = [local_image_generator_expansion, random_style_name] + style_keys
